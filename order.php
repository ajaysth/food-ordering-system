    ...
    <div class="container">
        ...
        <form action="" class="order" method="POST">
            ...
            <fieldset>
                ...
                <input type="text" name="full-name" placeholder="E.g. Ajay" class="input-responsive" required>

                <div class="order-label">Phone Number</div>
                <input type="tel" name="contact" placeholder="E.g. 9843xxxxxx" class="input-responsive" required>

                <div class="order-label">Email</div>
                <input type="email" name="email" placeholder="E.g. hi@ajsth.com" class="input-responsive" required>
